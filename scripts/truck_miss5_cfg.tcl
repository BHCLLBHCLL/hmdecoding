set log [open "D:/training/caedecoder/hmdecoding/output/ground_truth/truck_miss5_cfg.log" w]
proc logit {msg} {
  global log
  puts $log $msg
  flush $log
...
logit "readfile: $rr"
set f [open "D:/training/caedecoder/hmdecoding/output/ground_truth/truck_miss5.txt" r]
