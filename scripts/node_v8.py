...
def find_node_section_v8(p):
    ...
    for hi, count in hits[:300]:
        for base in range(hi - 32, hi + 44, 4):
            if base < 0: continue
            for stride, idoff, xoff, tailreq in ((52, 4, 12, False), (92, 4, 12, False), (56, None, 0, True), (132, 4, 12, False)):
                ok = 0; bad = 0
