...
set f [open "output/ground_truth/cc_elem.txt" w]
proc logit {msg} { global f; puts $f $msg; flush $f }
catch {*readfile "C:/Program Files/Altair/2019/tutorials/hm/c_channel-tcl.hm" 1} rerr
logit "read: $rerr"
catch {*createmark elements 1 "all"} _
set ids [hm_getmark elements 1]
logit "count=[llength $ids] first8=[lrange $ids 0 7]"
