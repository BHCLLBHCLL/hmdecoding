...
print('hook: same_cfg=%d diff_cfg=%d same_nds=%d diff_nds=%d only_dec=%d only_ora=%d (dec %d / ora %d)'%(same_cfg,diff_cfg,same_nds,diff_nds,only_dec,only_ora,len(set(dec)),len(oracle)))