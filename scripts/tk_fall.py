...
for (sh,segid,c71,cnt,X,Y) in D.find_elem_segments(p):
    ...
    if g and 219946 in g: print('segid',segid,'y4 eid219946:',g[219946])
    g2=D._parse_y7_elems(p,sh,cnt,row_count,row_map)
    if g2 and 219946 in g2: print('segid',segid,'y7 eid219946:',g2[219946])