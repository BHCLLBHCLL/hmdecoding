set log [open "D:/training/caedecoder/hmdecoding/output/ground_truth/seat_eid_meta.log" w]
proc logit {msg} {
  global log
  puts $log $msg
  flush $log
...
logit "readfile: $rr"
foreach eid {5545 5546 5547 5548 27495 27496 27497 27498 27499 27500 27501 27502 27503} {
  set cfg "?"; set nodes "?"
