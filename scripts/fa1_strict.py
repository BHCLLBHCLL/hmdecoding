...
valid=sorted(int(x.strip()) for x in open('output/ground_truth/fa1_nodes_all.txt',encoding='utf-8') if x.strip().isdigit())
print('valid:',len(valid))
ck('C:/Program Files/Altair/2019/tutorials/hm/frame_assembly_1.hm','output/ground_truth/elems/hm_frame_assembly_1.hm.elems.txt','fa1(plain)',None)
ck('C:/Program Files/Altair/2019/tutorials/hm/frame_assembly_1.hm','output/ground_truth/elems/hm_frame_assembly_1.hm.elems.txt','fa1(strict)',set(valid))