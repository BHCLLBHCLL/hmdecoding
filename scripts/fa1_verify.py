...
import os
for ef,label in [('output/ground_truth/elems/hm_frame_assembly_1.hm.elems.txt','hm_fa1'),('output/ground_truth/elems/lsdyna_frame_assembly_1.hm.elems.txt','lsdyna_fa1')]:
    print('effile',ef,os.path.exists(ef))